...
class TwoLayerNet(object):
    ...
    def loss(self, X, y=None):
        ...
        #calculate gradient
        dx2, grads['W2'], grads['b2'] = affine_backward(dx, self.cache['out'])
        dx3, grads['W1'], grads['b1'] = affine_relu_backward(dx2, self.cache['hidden'])
...
class FullyConnectedNet(object):
    ...
    def loss(self, X, y=None):
        ...
        '''
        #list stores activation for each layer
        # a = {'layer0': X, 'layer1': a2, ...}
        # cache stores x, W, b
        ...
        for i in range(self.num_layers):
            ...
            if i < self.num_layers - 1:
                if self.use_batchnorm and self.use_dropout:
                    ...
                    a[l], self.cache[l] = affine_batchnorm_relu_dropout_forward(a[l_prev], W, b, gamma, beta, bn_params,
                                                                                 self.droput_param)
                elif self.use_dropout:
                    a[l], self.cache[l] = affine_relu_dropout_forward(a[l_prev], W, b, self.droput_param)
